...
def process_whatsapp_message(body: dict):
    ...
    if message["type"] == "text":
        ...
        with open(f"33-FreightAgent/images/{id}.jpg", "wb") as f:
            f.write(image_res.content)
        if message_body.get("caption"):
            message_body = {'image_path': f'33-FreightAgent/images/{id}.jpg', 'caption': message_body.get("caption")}
        else:
            message_body = {'image_path': f'33-FreightAgent/images/{id}.jpg', 'caption': ''}
